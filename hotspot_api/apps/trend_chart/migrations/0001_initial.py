    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        max_digits=5,
                        verbose_name="当日平均最高温度（℃）",
                    ),
                ),
                (
                    "peak_temp",
                    models.DecimalField(
                        decimal_places=2, max_digits=5, verbose_name="当日峰值温度（℃）"
                    ),
                ),
                (
                    "avg_area_ratio",
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        max_digits=5,
                        verbose_name="当日最大热斑面积占比（%）",
                    ),
                ),
                (
                    "sample_count",
                    models.PositiveIntegerField(
                        default=0, verbose_name="当日原始采样条数"
                    ),
                ),
                (
                    "created_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "timestamp",
                    models.DateTimeField(verbose_name="采集时间戳（毫秒精度）"),
                ),
                ("branch", models.PositiveSmallIntegerField(verbose_name="支路编号")),
                (
                    "max_temp",
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        default=0, verbose_name="热斑数量"
                    ),
                ),
                (
                    "created_at",
                    models.DateTimeField(
                        auto_now_add=True, verbose_name="记录创建时间（入库时间）"
                    ),
                ),
            ],
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["branch", "timestamp"], name="idx_temp_branch_timestamp"
                    ),
                ],
            },
        ),
        ...
        migrations.AddIndex(
            model_name="temperaturedailystats",
            index=models.Index(
                fields=["branch", "stat_date"], name="idx_daily_stats_branch_date"
            ),
        ),
        migrations.AddConstraint(
            model_name="temperaturedailystats",
            constraint=models.UniqueConstraint(
                fields=("stat_date", "branch"), name="uk_daily_stats_date_branch"
            ),
        ),
        migrations.AddConstraint(
            model_name="temperaturedailystats",
