...
temperature_summary = HistoryTemperatureViewSet.as_view({'get': 'summary'})
...
urlpatterns = [
    ...
    # 3.2 温度统计汇总
    path('history/temperature/summary/', temperature_summary, name='history-temperature-summary'),
    # 3.3 温度历史导出
