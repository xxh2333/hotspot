...
urlpatterns = [
    ...
    path('operation/<int:pk>/', OperationLogDetailView.as_view(), name='operation_log_detail'),
    ...
    path('fault/<int:pk>/', MaintenanceLogDetailView.as_view(), name='maintenance_log_detail'),
